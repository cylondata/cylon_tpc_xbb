...
def data_dim(data_root, ctx):
    data_dim_arrow_table = csv.read_csv(data_root+"/date_dim/date_dim.dat", parse_options=csv.ParseOptions(delimiter="|"),
...
def inventory(data_root, ctx):
    inventory_arrow_table = csv.read_csv(data_root+"/inventory/inventory.dat", parse_options=csv.ParseOptions(delimiter="|"),
                                         convert_options=csv.ConvertOptions(
